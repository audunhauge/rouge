...
/**
 * @param {{ s_begin_r: (arg0: number) => string | number; numSolidTriangles: number; }} mesh
 * @param {any[]} r_water
 * @param {any[]} t_elevation
 * @param {any[]} t_downslope_s
 */
...
/**
 * @param {any[]} s_flow
 * @param {{ numSides: any; s_outer_t: (arg0: any) => any; }} mesh
 * @param {any[]} t_downslope_s
 * @param {any[]} river_t
 */
