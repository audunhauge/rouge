 ...
 * @param {{ numSides: number; s_begin_r: (arg0: number) => any; s_end_r: (arg0: number) => any; s_inner_t: (arg0: number) => any; }} mesh
 ...
 */
export const assign_t_elevation = /**
 * @param {number[]} t_elevation
 * @param {any[]} t_coastdistance
 * @param {number[]} t_downslope_s
 * @param {any} mesh
 * @param {{ [x: string]: any; }} r_ocean
 * @param {{ [x: string]: any; }} r_water
 * @param {(arg0: number) => any} randInt
 */
 function(
...
export const assign_r_elevation = /**
 * @param {number[]} r_elevation
 * @param {{ numRegions: number; r_circulate_t: (arg0: any[], arg1: number) => void; }} mesh
 * @param {{ [x: string]: number; }} t_elevation
 * @param {any[]} r_ocean
 */
 function(r_elevation, mesh, t_elevation, r_ocean) {
...
export const redistribute_t_elevation = /**
 * @param {number[]} t_elevation
 * @param {{ numSolidTriangles: number; }} mesh
 */
 function(t_elevation, mesh) {
